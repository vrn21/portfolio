...
From there, the workflow is repeatable: inspect traces for failures, fix tasks/tools/graders, push, rebuild, rerun. Don’t try to read too much into a single aggregate score—look at failure modes and the grader breakdown first.
